    ...
    return (
        <header style={{ display: 'flex', justifyContent: 'space-between', padding: '10px 50px', alignItems: 'center', backgroundColor: '#282c34', color: 'white' }}>
            ...
            <nav>
                ...
                <a href="/login" style={{ color: 'white', textDecoration: 'none', margin: '0 10px' }}>Login</a>
                <a href="/register" style={{ color: 'white', textDecoration: 'none', margin: '0 10px' }}>Register</a>
            </nav>
        </header>
    );
};
