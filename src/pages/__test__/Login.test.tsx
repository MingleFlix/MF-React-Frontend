...
describe('Login component', () => {
    ...
    it('submits the form successfully', async () => {
        ...
        await waitFor(() => expect(fetch).toHaveBeenCalledWith("/api/user-management/login", {"body": "{\"email\":\"test@example.com\",\"password\":\"password123\"}", "headers": {"Content-Type": "application/json"}, "method": "POST"}))
